function [m_theta,std_theta, stdm_theta] = direction_stats(theta, dt, task)
    ...
    %   Returns
    %   -------
    %   m_theta : Mean direction (Yamartino Method) ranging from [0,360].
    ...
    % 
    %   (2) Specify in documentation whether it matters if the angle varies
    %       from [-180, 180] or [0 360]. 
    % 
    %   (3) Make a option for output mtheta to vary from either [-180 180] or [0,360] 
    %
    %%%%
