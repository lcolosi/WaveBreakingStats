function buildBat(dirin_img,dirin_prj,proj_lat,proj_lon,trackNr,camName)
    ...
    bo_matrix = [cos(str2num(bore_ang{end-1})*pi/180)*cos(str2num(bore_ang{end})*pi/180), ...
                -cos(str2num(bore_ang{end-1})*pi/180)*sin(str2num(bore_ang{end})*pi/180),...
                 sin(str2num(bore_ang{end-1})*pi/180);...
                 cos(str2num(bore_ang{end-2})*pi/180)*sin(str2num(bore_ang{end})*pi/180)+sin(str2num(bore_ang{end-2})*pi/180)*sin(str2num(bore_ang{end-1})*pi/180)*cos(str2num(bore_ang{end})*pi/180),...
                 cos(str2num(bore_ang{end-2})*pi/180)*cos(str2num(bore_ang{end})*pi/180)-sin(str2num(bore_ang{end-2})*pi/180)*sin(str2num(bore_ang{end-1})*pi/180)*sin(str2num(bore_ang{end})*pi/180),...
                -sin(str2num(bore_ang{end-2})*pi/180)*cos(str2num(bore_ang{end-1})*pi/180);...
                 sin(str2num(bore_ang{end-2})*pi/180)*sin(str2num(bore_ang{end})*pi/180)-sin(str2num(bore_ang{end-1})*pi/180)*cos(str2num(bore_ang{end-2})*pi/180)*cos(str2num(bore_ang{end})*pi/180),...
                 sin(str2num(bore_ang{end-2})*pi/180)*cos(str2num(bore_ang{end})*pi/180)+cos(str2num(bore_ang{end-2})*pi/180)*sin(str2num(bore_ang{end-1})*pi/180)*sin(str2num(bore_ang{end})*pi/180),...
                 cos(str2num(bore_ang{end-2})*pi/180)*cos(str2num(bore_ang{end-1})*pi/180)];
