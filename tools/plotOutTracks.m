function plotOutTracks_V2(A,tracks,trackTag,dirV,An,dirout)
% This function plots out tracks, indicating wheter they are used or not
% and indicates which portion of the track was cropped (at the begining and
% at the end).
